...
import recognition.SRModels.EDVR.models.archs.arch_util as arch_util

try:
    from recognition.SRModels.EDVR.models.archs.dcn.deform_conv import (
        ModulatedDeformConvPack as DCN,
    )
except ImportError:
...
class TSA_Fusion(nn.Module):
    ...
    def forward(self, aligned_fea):
        ...
        att_L = F.interpolate(
            att_L, scale_factor=2, mode="bilinear", align_corners=False
        )
